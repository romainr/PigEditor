 ...
 * <ul>
 *   <li>{@link org.apache.pigeditor.pig.impl.QueryImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class QueryImpl extends MinimalEObjectImpl.Container implements Query
{
  ...
  {
    return PigPackage.Literals.QUERY;
  }
  ...
  public EList<Statement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Statement>(Statement.class, this, PigPackage.QUERY__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PigPackage.QUERY__ELEMENTS:
